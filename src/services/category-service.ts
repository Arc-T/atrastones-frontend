...
export class CategoryService {
    ...
    static async getAll(params?: Partial<CategoryFilter>) {
        return ApiClient
            .for<PaginatedResponse<Category>>(api.categories.list(params))
            .get();
    }

    static async getById(id: number) {
        return ApiClient
            .for<Category>(api.categories.details(id))
            .get();
    }

    static async create(data: Partial<Category>) {
        return ApiClient
            .for<Category>(api.categories.create)
    ...
    static async delete(id: number) {
        return ApiClient
            .for<void>(api.categories.details(id))
