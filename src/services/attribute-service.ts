...
export class AttributeService {
    ...
    static async getAll(params?: Partial<AttributeFilter>) {
        return ApiClient
            .for<PaginatedResponse<Attribute>>(api.attributes.list(params))
            .get();
    }
    ...
    static async create(data: Partial<Attribute>) {
        return ApiClient
            .for<Attribute>(api.attributes.create)
    ...
    static async update(id: number, data: Partial<Attribute>) {
        return ApiClient
            .for<Attribute>(api.attributes.update(id))
    ...
    static async delete(id: number) {
        return ApiClient
            .for<void>(api.attributes.delete(id))
